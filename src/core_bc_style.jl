...
BroadcastStyle(s1::DefaultArrayStyle, s2::MultiThreadStyle) = add_style(MultiThreadStyle, result_style(s1, s2.style), s2.nthread)
BroadcastStyle(s1::MultiThreadStyle, s2::DefaultArrayStyle) = add_style(MultiThreadStyle, result_style(s1.style, s2), s1.nthread)
